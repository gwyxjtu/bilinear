...
def McCormick(model,H,x,y,x1,x2,y1,y2):
...
def fix_solve(m_ht,m_fc):
    ...
    return res
def opt(obj,m_ht_1,m_ht_2,t_ht_1,t_ht_2,m_fc_1,m_fc_2,t_fc_1,t_fc_2):
    ...
    for i in range(period):
        ...
        m = McCormick(m,H_fc_fc[i],m_fc,t_fc[i],m_fc_1,m_fc_2,t_fc_1[i],t_fc_2[i])
        #m = McCormick(m,H_el_el[i],m_el,t_el[i],m_el_1,m_el_2,t_el_1[i],t_el_2[i])
        #print(i%24)
        #if i%24!=0 or i==0:
        m = McCormick(m,H_fc_ht[i],m_fc,t_ht[i],m_fc_1,m_fc_2,t_ht_1[i],t_ht_2[i])
        m = McCormick(m,H_ht_ht[i],m_ht,t_ht[i],m_ht_1,m_ht_2,t_ht_1[i],t_ht_2[i])
    ...
    return obj,m_ht_1,m_ht_2,t_ht_1,t_ht_2,m_fc_1,m_fc_2,t_fc_1,t_fc_2,H,error,ans
...
if __name__ == '__main__':
    ...
    max_err=[]
    mean_err=[]
    obj,m_ht_1,m_ht_2,t_ht_1,t_ht_2,m_fc_1,m_fc_2,t_fc_1,t_fc_2,H,error,res = opt(obj,m_ht_1,m_ht_2,t_ht_1,t_ht_2,m_fc_1,m_fc_2,t_fc_1,t_fc_2)
    m_ht_1,m_ht_2,t_ht_1,t_ht_2,m_fc_1,m_fc_2,t_fc_1,t_fc_2 = bound_con(H,gap,m_ht_1,m_ht_2,t_ht_1,t_ht_2,m_fc_1,m_fc_2,t_fc_1,t_fc_2,
        res['m_ht'],res['m_fc'],res['t_ht'],res['t_fc'],n,0.99)
    print(max(error))
    print(min(error))
    #exit(0)
    ...
    while max(error)>gap or min(error)<-gap:
        obj,m_ht_1,m_ht_2,t_ht_1,t_ht_2,m_fc_1,m_fc_2,t_fc_1,t_fc_2,H,error,res_new = opt(obj,m_ht_1,m_ht_2,t_ht_1,t_ht_2,m_fc_1,m_fc_2,t_fc_1,t_fc_2)
        if obj == 404:
            break
        res = res_new
        m_ht_1,m_ht_2,t_ht_1,t_ht_2,m_fc_1,m_fc_2,t_fc_1,t_fc_2 = bound_con(H,gap,m_ht_1,m_ht_2,t_ht_1,t_ht_2,m_fc_1,m_fc_2,t_fc_1,t_fc_2,
            res['m_ht'],res['m_fc'],res['t_ht'],res['t_fc'],n,0.95)
        #print(t_el_1,t_el_2)
